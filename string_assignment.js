...
let withoutLast = "hi my name is jaiden";
let lastIndex = withoutLast.lastIndexOf(" ");
let newString = withoutLast.substring(0,lastIndex);
...
//   ```
// ___
let bonus1 = "jonathann";
let even = bonus1.length % 2;
