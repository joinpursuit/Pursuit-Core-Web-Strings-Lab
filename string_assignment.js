...
let leaguer = "boyd";
console.log(leaguer[0]);
// 2. `console.log` the length of a string.
console.log(leaguer.length);
// 3. `console.log` the last character of any string.
console.log(leaguer[leaguer.length-1]);
// 4. Create a code block that takes a single string variable, and returns a copy of the string with the last letter capitalized. For example:
// 'jimmy'
// // => 'jimmY'
console.log(leaguer[0] + leaguer[1] + leaguer[2] + leaguer[leaguer.length-1].toUpperCase());
...
let weatherToday = "partly cloudy sunny";
if (weatherToday) {
  let withoutLast = weatherToday.split(" ");
  console.log(withoutLast.slice(0,2));
}
