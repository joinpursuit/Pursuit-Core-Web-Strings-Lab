...
// let string = 'famousName';
// let famousName = 'Michelle Obama'
// console.log(famousName.length - 1);
//
...
// let capitalized = firstName[firstName.length-1];
// console.log(firstName, capitalized);
//
// let name = 'alice'
...
// let amount = 1000000
// if (amount < 1000000){
// console.log(amount + ' dollars is not enough Mr. Bigglesworth!');
// } else {
